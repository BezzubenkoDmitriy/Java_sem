...
public class Task_3 {
    ...
    public static void main(String args[]) {
        int[] sortArr = {1, 2, 4, 5, -1, -2, -7, -4};
        int[] result = mergeSort(sortArr);
        System.out.println("Source List: " + Arrays.toString(sortArr));
        ...
        System.out.println("Average value: " + (double)Arrays.stream(result).sum()/result.length);
    }
}
